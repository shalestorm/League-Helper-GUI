# League-Helper-GUI
a simple GUI for a league of legends helper
Ill break down the format on how i made my GUI using Pythons Tkinter
To run the program  properly, the png file, and text document will both be necessary, simple put them all in a folder together



here's what the code looks like, keep in mind my footnotes, as this was for a school assignment
...
#do keep in mind that this was an earlier copy of the file before being finished. any tips and comments are welcome.
